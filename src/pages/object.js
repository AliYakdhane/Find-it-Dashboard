                        ...
                        <TableBody>
                          <TableRow style={{ display: 'flex', flexDirection: 'column' }}>
                            ...
                            <div component="th" scope="row">
                              ...
                              <TableCell align="right">{row.objectDate}</TableCell>
                            </div>
                            <div
                              style={{ display: 'flex', justifyContent: 'space-between' }}
                              component="th"
                            ...
                            >
                              ...
                              <TableCell align="right">
                                {row.formInput.Color ? row.formInput.Color : ' is empty'}
                              </TableCell>
                            </div>
                            <div
                              style={{ display: 'flex', justifyContent: 'space-between' }}
                            ...
                            >
                              ...
                              <TableCell align="right">
                                {row.formInput.Description ? row.formInput.Description : 'Empty'}
                              </TableCell>
                            </div>
                          </TableRow>
                        </TableBody>
                          ...
                          <Fade in={open}>
                            <Box sx={style}>
                              ...
                              <h5 style={{ color: 'blue', display: 'flex', justifyContent: 'center' }}>
                                Are you sure for delete this object!
                              </h5>
                              <br />
                              <br />
